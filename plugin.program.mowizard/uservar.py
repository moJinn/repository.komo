...
ADDONTITLE     = '[B][COLOR dodgerblue]MO[/COLOR][/B] Wizard'
BUILDERNAME    = 'MO'
...
BUILDFILE      = 'https://www.dropbox.com/s/tlex59vyitgdrd8/builds.txt?dl=1'
...
# Font size of header
FONTHEADER     = 'Font14'
HEADERMESSAGE  = '[B][COLOR dodgerblue]MO[/COLOR][/B] Wizard'
